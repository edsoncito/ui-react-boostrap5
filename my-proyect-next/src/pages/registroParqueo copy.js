...
const RegistroParqueo = (props) => {
    ...
    return (
      <div style={{
        ...
        <div className="col-md-2 col-6" style={{
          ...
          <HoraPicker ref={(ref) => { refs_pickers[dia + "inicio"] = ref }} defaultValue={!horario[dia] ? "09:00" : horario[dia].hora_inicio} onChange={(value) => {
            if (horario[dia]) {
        ...
        <div className="col-md-2 col-6" style={{
          ...
          <HoraPicker ref={(ref) => { refs_pickers[dia + "fin"] = ref }} defaultValue={!horario[dia] ? "19:00" : horario[dia].hora_fin} onChange={(value) => {
            if (horario[dia]) {
  ...
  if (props.state.parqueoReducer.estado == "exito" && props.state.parqueoReducer.type == "editar") {
    showModal()
    props.state.parqueoReducer.estado = "";
    // return <div/>
  }
  ...
  return (
    ...
    <>
      ...
      <div className="card mb-3">
        <div className="card-body">
          <form>
            ...
            {valorID ? <div className="mb-3 text-center "  >
              {/* <img style={{
                width: 150,
                height: 150
            ...
            <div className="row">
              <div className="col-md-12 mb-3">
                <label class="form-label">Propetario</label>
                <input type="text" className="form-control" placeholder="Propetario"
                  readOnly
            ...
            <div className="text-center">
              {Accion == "Editar" ?
                <button type="button" className="btn btn-warning" onClick={() => { ButtonCrear() }} >
                  EDITAR
          </button>
                :
                props.state.parqueoReducer.estado == "cargando" ?
                  ...
                  :
                  <button type="button" className="btn btn-primary" onClick={() => { ButtonCrear() }} >
                    REGISTRAR
            </button>
              }
      ...
      <ModalPadre titulo={tituloModal} show={Modal} handleClose={hideModal}>
      ...
      <ModalPadre titulo={"Propetario"} tamano="large" show={ModalPropetario} handleClose={() => {
        setModalPropetario(false)
      }}>
